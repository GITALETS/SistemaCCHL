...
function applyActiveProfileValues(profile) {
    ...
    // Set values on the hidden/disabled config inputs for compatibility with existing export code
    ...
    // Also keep back compatibility with individual localStorage entries
